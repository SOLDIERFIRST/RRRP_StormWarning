...
RegisterNetEvent('RRRP-Storm:client:15MinWarning', function(text)
    ...
    TriggerServerEvent("weathersync:setWeather", Config.FirstWeather, 1000, false, Config.Winter)
    TriggerServerEvent("weathersync:setWind", Config.WindDirection, Config.WindSpeed, true)
...
RegisterNetEvent('RRRP-Storm:client:10MinWarning', function(text)
    ...
    Citizen.Wait(math.random(15000, 25000))
    TriggerServerEvent("weathersync:setWeather", Config.SecondWeather, 1000, true, Config.Winter)
...
RegisterNetEvent('RRRP-Storm:client:5MinWarning', function(text)
    ...
    Citizen.Wait(math.random(15000, 25000))
    TriggerServerEvent("weathersync:setWeather", Config.ThirdWeather, 1000, true, Config.Winter)
    Citizen.Wait(math.random(10000, 20000))
    TsunamiEffect()
end)
-- 1 Minutes Reminder
